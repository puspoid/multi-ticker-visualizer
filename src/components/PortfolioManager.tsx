...
export function PortfolioManager({
    ...
    return (
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center transition-colors duration-300">
            <div className="flex items-center gap-3 overflow-x-auto pb-2 sm:pb-0 w-full sm:w-auto disable-scrollbars">
                ...
                {isEditing ? (
                    <div className="flex flex-col sm:flex-row items-center gap-2 w-full animate-in fade-in slide-in-from-right-4 duration-300">
                        <input
                            ...
                            className="px-3 py-1.5 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-md text-sm text-zinc-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-indigo-500 w-full sm:w-32 transition-colors"
                        />
                        <input
                            type="text"
                    ...
                    <div className="flex gap-2 w-full justify-end">
                        <button
                            ...
                            className="px-3 py-1.5 text-sm font-medium text-zinc-600 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-white bg-zinc-100 dark:bg-zinc-800/50 hover:bg-zinc-200 dark:hover:bg-zinc-800 rounded-md transition-colors flex items-center gap-2"
                        >
                            <Edit2 className="w-3.5 h-3.5" />
                            <span className="hidden sm:inline">Edit Current</span>
                        </button>
                        <button
